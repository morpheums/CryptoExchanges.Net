...
/// <summary>Marks an outgoing request as requiring OKX signing (timestamp + HMAC), applied per
/// attempt by the OKX signing handler.</summary>
internal static class OkxSigningRequest
{
    private static readonly HttpRequestOptionsKey<bool> SignedKey = new("okx.signed");
