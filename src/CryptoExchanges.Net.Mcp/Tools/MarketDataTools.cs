...
{
    private const string ExchangeParam = "Exchange id: one of binance, bybit, okx, bitget, kucoin, coinbase.";
    ...
    private static ToolError Unavailable(string exchange) =>
        new("ExchangeUnavailable", $"Exchange '{exchange}' is not one of: binance, bybit, okx, bitget, kucoin, coinbase.");
