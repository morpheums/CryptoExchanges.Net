...
using CryptoExchanges.Net.Logic.Clients.Base;

namespace CryptoExchanges.Net.Logic.Clients
{
    //public class BinanceClient : ExchangeClientBase, IExchangeClient
    //{
    //    #region Properties
    //    public ExchangeName Key { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    ...
    //    public string ApiSecret { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    //    #endregion
